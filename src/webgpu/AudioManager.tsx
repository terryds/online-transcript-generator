...
import { Transcriber } from "./useTranscriber";
...
export function AudioManager(props: { transcriber: Transcriber }) {
    ...
    const setAudioFromDownload = async (
        ...
        const audioCTX = new AudioContext({
            sampleRate: WebGPUConstants.SAMPLING_RATE,
        });
                    ...
                    <div className='flex justify-end items-center mb-3 px-1'>
                        <div className='flex'>
                            <input
                                ...
                                onChange={(e) => {
                                    let model = WebGPUConstants.DEFAULT_MODEL;
                                    if (!e.target.checked) {
                                        model += ".en";
                                    }
...
function UrlModal(props: {
    ...
    const [url, setUrl] = useState(WebGPUConstants.DEFAULT_AUDIO_URL);
