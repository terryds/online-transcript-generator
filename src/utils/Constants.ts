...
// WASM (non-WebGPU) constants
export const WASMConstants = {
    SAMPLING_RATE: 16000,
    DEFAULT_AUDIO_URL: `https://huggingface.co/datasets/Xenova/transformers.js-docs/resolve/main/${
        isMobileOrTablet ? "jfk" : "ted_60_16k"
    }.wav`,
...
// Export appropriate constants based on WebGPU availability
// @ts-expect-error - navigator.gpu may not exist
export const isWebGPUAvailable = !!navigator.gpu;

export default isWebGPUAvailable ? WebGPUConstants : WASMConstants;
